<?php
    ...
    $sql = "SELECT trans_id, total, `date-time` FROM transactions WHERE user_id = ? ORDER BY `date-time` ASC";
...
<html lang="en">
    <head>
        ...
        <title>John's Restaurant - Account</title>
    ...
    <body>
        ...
        <section class="hero" style="background-image: url('https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=1600&q=80');">
            <div class="container overlay">
                <div class="row">
                    <div class="col-12">
                        <h2 class="text-warning border-bottom pb-2">Your Order History</h2>
